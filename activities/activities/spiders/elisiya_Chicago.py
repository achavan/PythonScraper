...
##            print ("http://www.tripadvisor.ca/Attractions-g155019-Activities-c25-oa&i-Toronto_Ontario.html#TtD" % i)
            yield self.make_requests_from_url("http://www.tripadvisor.ca/Attractions-g35805-Activities-c25-oa%i-Chicago_Illinois.html#TtD" % i)
