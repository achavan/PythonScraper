...
##        "http://www.tripadvisor.ca/Attractions-g187147-Activities-c25-Paris_Ile_de_France.html"
    ...
    def start_requests(self):
        for i in xrange(30,100,30):
##            print ("http://www.tripadvisor.ca/Attractions-g155019-Activities-c25-oa&i-Toronto_Ontario.html#TtD" % i)
            yield self.make_requests_from_url("http://www.tripadvisor.ca/Attractions-g60713-Activities-c25-oa%i-San_Francisco_California.html#TtD" % i)
    ...
    def parse_item(self, response):
        self.f_sv = open('Sanfrancisco.csv', 'a')
