...
##        "http://www.tripadvisor.ca/Attractions-g187147-Activities-c25-Paris_Ile_de_France.html"
    ...
    def start_requests(self):
        for i in xrange(30,510,30):
            print ("http://www.tripadvisor.ca/Attractions-g60763-Activities-c25-oa%i-New_York_City_New_York.html#TtD" % i)
            yield self.make_requests_from_url("http://www.tripadvisor.ca/Attractions-g60763-Activities-c25-oa%i-New_York_City_New_York.html#TtD" % i)
                ...
                for title in soup2.findAll('div',attrs={'class':'brandArea'}):
                    ...
                    for ra in soup2.findAll('div',attrs={'class':"reviewSelector "}):
                        ...
                        for j in ra.findAll("div",attrs={'class':"entry"}):
                            ...
                            review=tempreview.encode('utf-8')
...
##                memberInfo=memberInfo+k.text+" "
        ...
        rating=list1[3]
        review=list1[4]
        rev=review.encode('utf-8')
##        print rating
##        print review
##        print "***********************"
        rows=[(memberName,memberCity,memberCountry,memberGender,memberAge,Citiesvisited,memberDescription,acti,typ1,description,rating,rev)]
