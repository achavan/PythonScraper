...
class ConcordiaSpider(CrawlSpider):
    name = "Elisiya_montreal"
    #allowed_domains = ["www.tripadvisor.ca"]
    start_urls = [
       "http://www.tripadvisor.ca/Attractions-g155032-Activities-c25-Montreal_Quebec.html#TtD",
       "http://www.tripadvisor.ca/Attractions-g155032-Activities-c25-oa30-Montreal_Quebec.html#TtD"
       "http://www.tripadvisor.ca/Attractions-g155032-Activities-c25-oa60-Montreal_Quebec.html#TtD"
    ]
    ...
    def parse_item(self, response):
        self.f_sv = open('itemsmontreal.csv', 'a')
...
##                memberInfo=memberInfo+k.text+" "
        ...
        description=list1[2]
        rating=list1[3]
        review.append(list1[4])
        print "***********************"
        print review
        print rating
        print description
        
        rows=[(memberName,memberCity,memberCountry,memberGender,memberAge,Citiesvisited,memberDescription,acti,typ1,description,rating,review[0])]
